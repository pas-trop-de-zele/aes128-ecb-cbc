...
public:
    ...
    void set_secret_message(std::string &secret_message_);
    ...
    void ensure_enough_blocks(std::vector<KeyBlock *> &block_container, int blocks_needed);
    std::string show_encrypted_blocks();
